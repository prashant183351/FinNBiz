...
const translations: Translations = {
  en: {
    ...
    'auth.login.update_title': 'Update Credentials',
    'auth.login.update_subtitle': 'Update your email or password',
    'auth.login.update_btn': 'Update & Login',
    'auth.login.update_success': 'Credentials updated successfully. Logging in...',
    'auth.login.forgot_password': 'Forgot Email / Password?',
    ...
    'hr.attendance.gps_outside': '⚠️ Outside Geofence Area',
    'hr.attendance.gps_inside': '✅ Within Geofence Area',
    'hr.attendance.gps_locating': 'Locating GPS...',
    'hr.attendance.gps_unsupported': 'GPS Unsupported or Perm Denied',
    'hr.attendance.lat': 'Latitude',
    'hr.attendance.lng': 'Longitude',
    'hr.payroll.upi_vpa': 'UPI ID / VPA',
    'hr.payroll.upi_pay': 'UPI Pay',
    'hr.payroll.upi_modal_title': 'Salary UPI Disbursement',
    'hr.payroll.whatsapp_payslip': 'WhatsApp Payslip',
    'hr.payroll.send_success': 'Payslip successfully sent on WhatsApp!',
    'hr.payroll.upi_success': 'UPI Payment disbursed successfully!',
  ...
  hi: {
    ...
    'auth.login.update_title': 'क्रेडेंशियल्स अपडेट करें',
    'auth.login.update_subtitle': 'अपना ईमेल या पासवर्ड अपडेट करें',
    'auth.login.update_btn': 'अपडेट करें और लॉगिन करें',
    'auth.login.update_success': 'क्रेडेंशियल्स सफलतापूर्वक अपडेट किए गए। लॉगिन किया जा रहा है...',
    'auth.login.forgot_password': 'ईमेल या पासवर्ड भूल गए?',
    ...
    'hr.payroll.title': 'पेरोल Processing',
    'hr.payroll.desc': 'वेतन जनरेट करें और चयनित महीने के लिए शुद्ध वेतन (Net Pay) देखें।',
    'hr.attendance.gps_outside': '⚠️ जियोफेंस सीमा के बाहर',
    'hr.attendance.gps_inside': '✅ जियोफेंस सीमा के भीतर',
    'hr.attendance.gps_locating': 'जीपीएस खोजा जा रहा है...',
    'hr.attendance.gps_unsupported': 'जीपीएस समर्थित नहीं है या अनुमति अस्वीकृत',
    'hr.attendance.lat': 'अक्षांश (Lat)',
    'hr.attendance.lng': 'रेखांश (Lng)',
    'hr.payroll.upi_vpa': 'यूपीआई आईडी (UPI ID)',
    'hr.payroll.upi_pay': 'यूपीआई भुगतान (UPI Pay)',
    'hr.payroll.upi_modal_title': 'यूपीआई वेतन संवितरण',
    'hr.payroll.whatsapp_payslip': 'व्हाट्सएप पे-स्लिप',
    'hr.payroll.send_success': 'पे-स्लिप व्हाट्सएप पर सफलतापूर्वक भेजी गई!',
    'hr.payroll.upi_success': 'यूपीआई भुगतान सफलतापूर्वक संवितरित किया गया!',
